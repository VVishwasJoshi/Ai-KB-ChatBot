...
The backend is already set up for Vercel. Just run:
...
Then deploy the `dist` folder to Vercel, Netlify, or wherever you host static sites.
...
- Try a different port if 5000 is already in use
